(function () {
    ...
    var css = "[data-lba-theme=light]{--lba0:#000;--lba1:#fff;--lba2:rgba(255,255,255,.85);--lba3:#dcdcdc;--lba4:#e6e6e6;--lba5:#dcdcdc;}[data-lba-theme=dark]{--lba0:#e7eae1;--lba1:#111;--lba2:rgba(17,17,17,.85);--lba3:#333;--lba4:#393939;--lba5:#666;}html{--lba6: rgb(248, 205, 5);}.pz-game-field{background:inherit;color:inherit}.sb-wordlist-items .sb-pangram{border-bottom:2px var(--lba6) solid}.sb-wordlist-items .sb-anagram a{color:var(--lba5)}.sb-modal-scrim{z-index:6}[data-lba-theme=dark]{background:var(--lba1);color:var(--lba0)}[data-lba-theme=dark] .pz-nav__hamburger-inner,[data-lba-theme=dark] .pz-nav__hamburger-inner::before,[data-lba-theme=dark] .pz-nav__hamburger-inner::after{background-color:var(--lba0)}[data-lba-theme=dark] .pz-nav{width:100%;background:var(--lba1)}[data-lba-theme=dark] .pz-nav__logo{filter:invert(1)}[data-lba-theme=dark] .sb-modal-scrim{background:var(--lba2);color:var(--lba0)}[data-lba-theme=dark] .pz-modal__title{color:var(--lba0)}[data-lba-theme=dark] .sb-modal-frame,[data-lba-theme=dark] .pz-modal__button.white{background:var(--lba1);color:var(--lba0)}[data-lba-theme=dark] .pz-modal__button.white:hover{background:var(--lba4)}[data-lba-theme=dark] .sb-message{background:var(--lba4)}[data-lba-theme=dark] .sb-input-invalid{color:var(--lba5)}[data-lba-theme=dark] .sb-toggle-expand{box-shadow:none}[data-lba-theme=dark] .sb-progress-marker .sb-progress-value,[data-lba-theme=dark] .hive-cell.center .cell-fill{background:var(--lba6);fill:var(--lba6);color:var(--lba1)}[data-lba-theme=dark] .sb-input-bright{color:var(--lba6)}[data-lba-theme=dark] .hive-cell.outer .cell-fill{fill:var(--lba4)}[data-lba-theme=dark] .cell-fill{stroke:var(--lba1)}[data-lba-theme=dark] .cell-letter{fill:var(--lba0)}[data-lba-theme=dark] .hive-cell.center .cell-letter{fill:var(--lba1)}[data-lba-theme=dark] .hive-action:not(.hive-action__shuffle){background:var(--lba1);color:var(--lba0)}[data-lba-theme=dark] .hive-action__shuffle{filter:invert(100%)}[data-lba-theme=dark] *:not(.hive-action__shuffle):not(.sb-pangram):not(.lba-current){border-color:var(--lba3) !important}.lba{position:absolute;z-index:3;width:160px;box-sizing:border-box;padding:0 10px 5px;background:var(--lba1);border-width:1px;border-color:var(--lba3);border-radius:6px;border-style:solid}.lba *,.lba *:before,.lba *:after{box-sizing:border-box}.lba *:focus{outline:0}.lba [data-ui=header]{display:flex;gap:8px}.lba [data-ui=header] .toolbar{display:flex;align-items:stretch;gap:1px}.lba [data-ui=header] .toolbar div{padding:10px 3px 2px 3px}.lba [data-ui=header] .toolbar div:last-of-type{padding-top:8px}.lba [data-ui=header] svg{width:11px;cursor:pointer;fill:currentColor}.lba .header{font-weight:bold;line-height:32px;flex-grow:2}.lba .minimizer{transform:rotate(180deg);transform-origin:center;position:relative;top:2px}.lba.inactive details,.lba.inactive [data-ui=footer]{display:none}.lba.inactive [data-tool=setUp]{position:relative;pointer-events:none}.lba.inactive [data-tool=setUp]:before{content:\"\";width:100%;height:100%;background-color:var(--lba2);cursor:default;display:block;position:absolute;top:0;left:0}.lba.inactive .minimizer{transform:rotate(0deg);top:0}.lba details{font-size:90%;max-height:800px;transition:max-height .25s ease-in;margin-bottom:1px}.lba details[open] summary:before{transform:rotate(-90deg);left:10px;top:1px}.lba details.inactive{height:0;max-height:0;transition:max-height .25s ease-out;overflow:hidden;margin:0}.lba summary{font-size:13px;line-height:22px;padding:1px 15px 0 21px;background:var(--lba4);color:var(--lba0);cursor:pointer;list-style:none;position:relative;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.lba summary::-webkit-details-marker{display:none}.lba summary:before{content:\"❯\";font-size:9px;position:absolute;display:inline-block;transform:rotate(90deg);transform-origin:center;left:7px;top:0}.lba .pane{border:1px solid var(--lba3);border-top:none;width:100%;font-size:85%;margin-bottom:2px}.lba table{border-collapse:collapse;table-layout:fixed}.lba tr.lba-current{font-weight:bold;border-bottom:2px solid var(--lba6) !important}.lba td{border:1px solid var(--lba3);border-top:none;white-space:nowrap;text-align:center;padding:4px 0;width:26px}.lba td:first-of-type{text-align:left;width:auto;overflow:hidden;text-overflow:ellipsis;padding:4px 3px}.lba [data-ui=scoreSoFar] tbody tr:first-child td,.lba [data-ui=spoilers] tbody tr:first-child td{font-weight:bold}.lba [data-ui=footer]{color:currentColor;opacity:.6;font-size:10px;text-align:right;display:block;padding-top:8px}.lba [data-ui=footer]:hover{opacity:.8;text-decoration:underline}.lba .spill-title{padding:10px 6px 0;text-align:center}.lba .spill{text-align:center;padding:17px 0;font-size:280%}.lba ul.pane{padding:5px}.lba [data-ui=surrender] .pane{padding:10px 5px}.lba [data-ui=surrender] button{margin:0 auto;display:block;font-size:100%;white-space:nowrap;padding:12px 10px}.lba label{cursor:pointer;position:relative;line-height:19px}.lba label input{position:relative;top:2px;margin:0 10px 0 0}@media(min-width: 768px){.lbaContainer{width:100%;max-width:1080px;margin:0 auto;height:0;overflow-y:visible;position:relative;z-index:5}.lba{left:100%;top:64px}}@media(max-width: 1444px){.lbaContainer{max-width:none}.lba{top:16px;left:12px}}@media(max-width: 767.98px){.lba{top:167px}.pz-mobile .lba{top:auto;bottom:-7px}}";
    ...
    class StepsToSuccess extends Plugin {
        ...
        markCurrentTier(pane) {
            ...
            el.$$('td', pane).forEach(cell => {
                cell.parentNode.classList.remove('lba-current');
                if (parseInt(cell.textContent) === currentTier) {
                    cell.parentNode.classList.add('lba-current');
                }
            });
        }
        constructor(app) {
