class data {
     ...
     */
    getSize (type) {
        if (typeof this[type] === 'undefined' || (typeof data[type].length === 'undefined' && typeof data[type].size === 'undefined')) {
    ...
    constructor(maxWords) {
        /**
         * {Set} all available terms
         */
        this.dictionary = new Set(window.gameData.dictionary);

        /**
         * {Set} all available letters
         */
        this.allLetters = new Set(window.gameData.sides.join('').split(''));
         ...
         * {Set} solution
         */
        this.solution = new Set(window.gameData.ourSolution);
